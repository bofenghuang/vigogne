...
# Modified from: https://github.com/tatsu-lab/stanford_alpaca/blob/eb5b171d9b103a12a8e14e0edca9cbc45fe1d512/train.py#L166-L182
...
# Almost same to transformers.DataCollatorForSeq2Seq
@dataclass
class Seq2SeqDataCollatorForSupervisedDataset(object):
    """Collate examples for supervised fine-tuning."""
